...
const mockCourses: Course[] = [
  ...
  },
  {
    ...
    description:
      "This course is great preparation for any TypeScript programming interviews that you may have coming up.",
    videoUrl:
  ...
  },
  {
    ...
    description:
      "Do you want to build fast and powerful back-end applications with JavaScript? Would you like to become a more complete and in-demand developer? Then Node.js is the hot technology for you to learn right now, and you came to the right place to do it!",
    videoUrl:
